...
Depuis plus d'un siècle, le "contrôle primaire" reste au cœur de la Technique Alexander. F.M. Alexander décrivait une relation dynamique entre la tête, le cou et le dos – une coordination fondamentale qui, lorsqu'elle n'est pas interférée, permet un usage optimal de soi.
...
- Les **récepteurs de pression** cutanés et plantaires
- Les **fuseaux neuromusculaires** et capteurs musculo-tendineux (sensibilité proprioceptive profonde)
...
- **Non directement perçu** : On ne "sent" pas la gravité elle-même
- **Émergent** : Il résulte de la convergence de multiples flux sensoriels
- **Organisateur** : Il structure la coordination motrice et tonique
- **Implicite** : Il opère généralement en-deçà de la conscience réfléchie
...
**5. L'intégration centrale**
Ces informations convergent dans le système nerveux central (cervelet, noyaux vestibulaires, cortex pariétal...) pour produire une **représentation dynamique** de notre relation à la gravité.
