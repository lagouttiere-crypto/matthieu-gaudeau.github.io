...
Le geste s'actualise toujours dans un environnement qui offre des [[Lapi_Cordel|Possibilités d'action]] — ce que Gibson nomme [[Concepts/Affordance|Affordance]]. Mais contrairement à une lecture behavioriste, l'affordance n'est pas une propriété objective de l'environnement : elle émerge du couplage entre la [[Invite|gestosphère de l'individu et le contexte]].
