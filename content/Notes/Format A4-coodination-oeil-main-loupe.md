...
**Pour rappel** : Le **format A4** (210 × 297 mm) n'est pas naturel. C'est une norme ISO (ISO 216) adoptée en 1975, dérivée du format allemand DIN 476 de 1922. Mais cette normalisation _technique_ a produit une normalisation _cognitive_.
...
C'est un format qui s'est calibré sur les **possibilités de notre système visuomoteur** — ou plutôt, notre système s'est habitué à ce format au point qu'il nous semble "naturel".
On voit aussi à quel point ce format est adapté au système est adapté à notre [[Le modèle éducatif français hérité du modèle carcéral|modèle éducatif]] (hérité du model carcéral).
...
- Une pression qui _semble_ normale à l'œil correspond à un geste d'une délicatesse extrême
